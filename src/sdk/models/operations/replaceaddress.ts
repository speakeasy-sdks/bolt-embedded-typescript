...
export class ReplaceAddressSecurity extends SpeakeasyBase {
...
export class ReplaceAddressRequest extends SpeakeasyBase {
    /**
 ...
 */
export class ReplaceAddress200ApplicationJSON extends SpeakeasyBase {
    /**
...
export class ReplaceAddressResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
