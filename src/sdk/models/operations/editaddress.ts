...
export class EditAddressSecurity extends SpeakeasyBase {
...
export class EditAddressRequest extends SpeakeasyBase {
    /**
...
export class EditAddressResponse extends SpeakeasyBase {
    /**
